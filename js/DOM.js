...
DOM.regularTags = DOM.regularTagString.split(",").filter(function (o) {
  return o;
});
DOM.svgTags = DOM.svgTagString.split(",").filter(function (o) {
  return o;
});
...
DOM.element = function () {
  ...
  if (Array.isArray(children)) {
    //probably another jquery object
...
var combined = new Set([].concat(DOM.regularTags).concat(DOM.svgTags));
